...
// Make Sure that in Form Tag of Search method is GET, and action is same page.
// Handle GET Request now here.
if (isset($_GET['search'])) {
  $search = $_GET['search'];
  header("location: search.php?search=" . $search);
}
?>
<!-- Bootstrap Starter Template  for Version 5-->
<!-- Source: https://v5.bootstrap.com/ -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
